$(document).ready(function() {
    ...
    // --- Chats Badge (Unread) ---
    // Sidebar notifications are disabled. This is intentionally left blank so that
    // unread indicators only appear inside the chat UI, not the sidebar.
    function updateChatsBadge(unreadCount) {
        // no-op
        $('#chats-badge').hide(); // Hide if present in DOM for legacy pages
    }
    // Remove global setter to avoid sidebar badge updates
    // window.setUnreadChats is intentionally undefined now.
